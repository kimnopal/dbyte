        ...
        <nav className={`fixed top-0 left-0 right-0 ${scrollPosition > 0 ? 'shadow-lg bg-white' : ''}`}>
            <div className="px-4 py-2 md:max-w-[865px] m-auto">
                <div className="flex justify-between items-center">
                    ...
                    <div ref={navLinksWrapper}>
                        <div
                            className={`${isToggle ? 'visible opacity-100 !top-[120%]' : 'invisible'} opacity-0 flex flex-col items-center absolute top-[110%] right-4 transition-all px-4 py-3 rounded-md bg-white shadow-xl border border-secondary md:border-none md:shadow-none md:visible md:opacity-100 md:flex-row md:static md:px-0 md:py-0 md:gap-7 md:bg-transparent`}>
                        ...
                        <div className="flex flex-col gap-[5px] cursor-pointer md:hidden" onClick={() => setIsToggle(!isToggle)}>
